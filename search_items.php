...
<div class="container">
    ...
    <div class="row">
        ...
        <?php
            $terms = $_GET['terms'];
            $get_pro = "SELECT * from products WHERE  (product_title LIKE '%".$terms."%') OR (product_desc LIKE '%".$terms."%') OR (`product_keywords` LIKE '%".$terms."%')";
            $run_pro = mysqli_query($con, $get_pro);
            ?>
            <h1 style="margin-top:40px; padding-bottom:10px; text-align:center">Search results for: <?= $terms ?></h1>
            <div class="row">
                <?php
